...
@bp.route('/0.html')
def pset0():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/0.md", "r") as f:
...
@bp.route('/1.html')
def pset1():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/1.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/2.html')
def pset2():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/2.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/3.html')
def pset3():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/3.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/4.html')
def pset4():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/4.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/5.html')
def pset5():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/5.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/6.html')
def pset6():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/6.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/7.html')
def pset7():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/7.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/8.html')
def pset8():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/8.md", "r") as f:
        markdown_text = f.read()
...
@bp.route('/9.html')
def pset9():
    with open(f"cs50x/content/{os.environ['COURSE_LANGUAGE']}/psets/9.md", "r") as f:
        markdown_text = f.read()
